...
const
 ...
 // Савельев:
 //1. Заменил обороты на генерируемый и редактируемый список (с сохранением и загрузкой)
 //2. Добавил возможность копировать данные таблиц диапазонами (коэффициенты, бензин и газ)
 //3. Добавил задание газовой карты из Lovato и пересчет ее на коэффициенты (для типов 2 и 3)
